...
namespace Stater.CodeGeneration.LanguageAdapter.CSharp;

public class CSharpAdapter: BaseLanguageAdapter
{
    protected override string TemplateName => "csharp";
    protected override string TestTemplateName => "csharp-test";
