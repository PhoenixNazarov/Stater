...
namespace Stater.CodeGeneration.LanguageAdapter.CPlusPlus;

public class CPlusPlusAdapter: BaseLanguageAdapter
{
    protected override string TemplateName => "cplusplus";
    protected override string TestTemplateName => "cplusplus-test";
    ...
    protected override string GetVariableValueTypeName(VariableValue value)
    {
        return value switch
        {
            ...
            VariableValue.StringVariable => "std::string",
