...
public class Parser
{
    ...
    private SlxState ParseState(XmlNode xmlNode)
    {
        var state = new SlxState
        {
            Id = ParseId(xmlNode)
        };
                        ...
                        if (childrenNode.Name == "P")
                        {
                            ...
                            switch (name)
                            {
                                ...
                                case "useCustomEnumTypeName":
                                    SlxState.ActiveStateOutput.UseCustomEnumTypeName = ParseBool(node.InnerText);
                                    break;
                                case "enumTypeName":
    ...
    private SlxTransition ParseTransition(XmlNode xmlNode)
    {
        var transition = new SlxTransition
        {
            Id = ParseId(xmlNode)
        };
    ...
    private static Models.Data ParseData(XmlNode xmlNode)
    {
